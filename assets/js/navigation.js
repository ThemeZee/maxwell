/* global maxwellScreenReaderText */
/**
 * Theme Navigation
 *
 * @package Maxwell
...
(function( $ ) {
	...
	function initNavigation( containerClass, naviClass ) {
		...
		(function() {
			...
			menuToggle.on( 'click.maxwell_', function() {
		...
		(function() {
			...
			var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false } )
				.append( maxwellScreenReaderText.icon )
				.append( $( '<span />', { 'class': 'screen-reader-text', text: maxwellScreenReaderText.expand } ) );
			...
			navigation.find( '.current-menu-ancestor > button' )
				...
				.text( maxwellScreenReaderText.collapse );
			...
			navigation.find( '.dropdown-toggle' ).click( function( e ) {
				...
				screenReaderSpan.text( screenReaderSpan.text() === maxwellScreenReaderText.expand ? maxwellScreenReaderText.collapse : maxwellScreenReaderText.expand );
			} );
		})();
		...
		(function() {
			...
			function toggleFocusClassTouchScreen() {
				if ( 'none' === $( '.menu-toggle' ).css( 'display' ) ) {
					...
					$( document.body ).on( 'touchstart.maxwell_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' )
						.on( 'touchstart.maxwell_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' ).unbind( 'touchstart.maxwell_' );
				}
			}

			if ( 'ontouchstart' in window ) {
				$( window ).on( 'resize.maxwell_', toggleFocusClassTouchScreen );
				toggleFocusClassTouchScreen();
			}

			menuList.find( 'a' ).on( 'focus.maxwell_ blur.maxwell_', function() {
