...
class Maxwell_Magazine_Posts_Boxed_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			sprintf( esc_html__( 'Magazine Posts: Boxed (%s)', 'maxwell' ), wp_get_theme()->Name ), // Name
			array( 
				'classname' => 'maxwell-magazine-posts-boxed', 
				'description' => esc_html__( 'Displays your posts from a selected category in a boxed layout. Please use this widget ONLY in the Magazine Homepage widget area.', 'maxwell' ) 
			) // Args
		);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('layout'); ?>"><?php esc_html_e( 'Post Layout:', 'maxwell' ); ?></label><br/>
			<select id="<?php echo $this->get_field_id('layout'); ?>" name="<?php echo $this->get_field_name('layout'); ?>">
				<option <?php selected( $settings['layout'], 'horizontal' ); ?> value="horizontal" ><?php esc_html_e( 'Horizontal Arrangement', 'maxwell' ); ?></option>
				<option <?php selected( $settings['layout'], 'vertical' ); ?> value="vertical" ><?php esc_html_e( 'Vertical Arrangement', 'maxwell' ); ?></option>
			</select>
		</p>
...
// Register Widget
add_action( 'widgets_init', 'maxwell_register_magazine_posts_boxed_widget' );

function maxwell_register_magazine_posts_boxed_widget() {

	register_widget( 'Maxwell_Magazine_Posts_Boxed_Widget' );
