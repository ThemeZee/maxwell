...
function maxwell_customize_preview_js() {
	wp_enqueue_script( 'maxwell-customizer-preview', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20161214', true );
}
...
function maxwell_customize_preview_css() {
	wp_enqueue_style( 'maxwell-customizer-css', get_template_directory_uri() . '/css/customizer.css', array(), '20161214' );
}
...
function maxwell_customize_theme_links() {
	...
	?>
		...
		<div class="theme-links">
			...
			<p>
				<a href="http://preview.themezee.com/?demo=maxwell&utm_source=theme-info&utm_medium=textlink&utm_campaign=maxwell&utm_content=demo" target="_blank">
